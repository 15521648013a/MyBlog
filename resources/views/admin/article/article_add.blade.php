		...
		<div class="container">
			<form  action="create" method="post">
				...
				<div class="form-group">
                    ...
                    <input type="text" name="thumb" value="" id="pei" class="form-control" placeholder="请输入配图URL"/>
				...
				<input type="submit" id="send1" name="" value="创建" class="btn btn-primary" />
			</form>
		</div>

		<script src="/MyBlog/public/ext/ueditor/ueditor.config.js" type="text/javascript" charset="utf-8"></script>
		<script src="/MyBlog/public/ext/ueditor/ueditor.all.js" type="text/javascript" charset="utf-8"></script>
